...
# train test split to train data. Test size determines % of data that will be used for testing and remaining for training
time_train, time_test, score_train, score_test = train_test_split(time_studied, score, test_size=0.2)
